...
def main():
    print("爬取到的https://www.alexa.com/topsites网站的主页内容以及排名前30网站主页的内容")
    # askURL('https://www.youtube.com/')


    baseurl = "https://www.alexa.com/topsites"
    datalist = getData(baseurl)
    # print(datalist)

    # askURL("https://www.google.com/")
    ...
    for i in range(2, 30):
        try:
            ...
            df.to_csv('E:\pycharm project\spider\spider2\spider2.csv', mode='a', header=False)
            askURL(url1)
...
def askURL(url):
    ...
    head = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) "
                      "Chrome/89.0.4389.90 Safari/537.36", "Connection":"close"}
    ...
    try:
        ...
        #
        # df.to_csv('E:\pycharm project\spider\spider2\csv', mode='a', header=False)
